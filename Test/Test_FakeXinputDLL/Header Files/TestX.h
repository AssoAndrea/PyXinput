#pragma once
#ifdef FAKEXINPUT_EXPORTS
#define FAKEXINPUT_API __declspec(dllexport)
#else
#define FAKEXINPUT_API __declspec(dllimport)
#endif
...
extern "C" {
    ...
    BOOL FAKEXINPUT_API XInputEnable
    (
        _In_ BOOL enable     // [in] Indicates whether xinput is enabled or disabled. 
    );


    DWORD FAKEXINPUT_API XInputGetAudioDeviceIds
    (
        _In_  DWORD                             dwUserIndex,        // Index of the gamer associated with the device
    ...
    DWORD FAKEXINPUT_API XInputGetBatteryInformation
    (
        _In_  DWORD                       dwUserIndex,        // Index of the gamer associated with the device
    ...
    DWORD FAKEXINPUT_API XInputGetDSoundAudioDeviceGuids
    (
        _In_  DWORD     dwUserIndex,          // Index of the gamer associated with the device
    ...
    DWORD FAKEXINPUT_API XInputGetKeystroke
    (
        _In_       DWORD dwUserIndex,              // Index of the gamer associated with the device
